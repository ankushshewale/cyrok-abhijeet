...
// Solutions list for overview page
export const solutions: Solution[] = [
  ...
  },
  {
    ...
    items: ['SAN/NAS deployment', 'Backup & disaster recovery'],
  },
  {
  ...
  },
  {
    ...
    items: ['CCTV deployment', 'Access control automation'],
  },
  {
    ...
    items: ['Laptops, desktops, servers', 'Bulk enterprise rentals'],
  },
];

// Solution details for detail pages
